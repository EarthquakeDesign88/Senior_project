...
<?php 
  ...
  $id = $_GET['id_form'];
  $sql = "SELECT id_form,area_floor.floor ,area.areaname AS area,name,phone,image, datetime_submit,status.status_detail AS status, update_status ,topic,detail,update_admin
  FROM form 
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../report_inprogress"> Report in progress </a></li>
