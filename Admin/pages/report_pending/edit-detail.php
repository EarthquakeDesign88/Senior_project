...
<?php 
  ...
  $id = $_GET['id_form'];
  $sql = "SELECT id_form,area_floor.floor ,area.areaname AS area,name,phone,topic,detail,image, datetime_submit,status.status_detail AS status, update_status ,update_admin
  FROM form 
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../report_pending"> Report pending </a></li>
