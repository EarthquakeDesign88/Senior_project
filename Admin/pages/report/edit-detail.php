...
<?php 
  ...
  $id = $_GET['id_form'];
  $sql = "SELECT id_form,area_floor.floor ,area.areaname AS area,name,phone,image, datetime_submit,topic,status.status_detail AS status, update_status ,topic,detail,update_admin
  FROM form 
    ...
    <section class="content">
      <div class="card card-primary">
        ...
        <div class="card-body">
           ...
           <div class="row text-center">
              <div class="col-sm-12">
                <i class="fas fa-image fa-3x pt-5 pb-5">  Image <br> 
