...
<?php 
  ...
  $sql = "SELECT id_form,area_floor.floor ,area.areaname AS area,name,topic, datetime_submit,status.status_detail AS status, update_status ,update_admin
  FROM form 
        ...
        <div class="card-body">
            ...
            ?>
              <tr class="text-center">
                ...
                <td>
                  <a href="edit-detail.php?id_form=<?php echo $row['id_form']; ?>" class="btn btn-sm btn-primary text-white">
