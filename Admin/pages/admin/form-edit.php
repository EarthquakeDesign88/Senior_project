        ...
        <form role="form" action="update.php" method="post">
          <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="phone" class="form-control" name="phone" id="phone" placeholder="Phone" value="<?php echo $row['phone'];?>"required>   
            </div>

            <div class="form-group">
                <label for="line"> Line  </label>
                <input type="line" class="form-control" name="line_id" id="line_id" placeholder="Line id" value="<?php echo $row['line_id'];?>"required>   
            </div>
