<?php 
  ...
  $sql = "SELECT id_form, area_floor.floor, area.Areaname AS Area, topic, status.status_detail AS Status 
  FROM form
...
<body>
    ...
    <header  class="page-title jarallax" data-jarallax ='{"speed": 0.6}' style="background-image: url('https://www.rockwellautomation.com/resources/images/rockwellautomation/publication/repair-shutterstock_133644224--photograph_848w477h.jpg');">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class = "display-5 font-weight-bold text-center " style="color: #000000; font-size: 6rem" > 2<sup>nd</sup> Floor </h1>
    ...
    <section class="container py-3">
      <div class="row">
        <div class="col-12">
            <h1 class = "border-short-bottom text-center" style="color: #000000 "> 2<sup>nd</sup> Floor Plan </h1>
        </div>
      </div>
    ...
    <section>
      <div class="row">
        <div class="col-md-12">
            <img src="assets/image/diagram/f2.jpg"class="img-fluid p-1" width="1300" height="200" alt="">
        </div>
              ...
              <form method = "post" action ="php/form.php" enctype = "multipart/form-data">
                <div class="form-row">
                  ...
                  <label for="floor"> Floor </label>
                    <input  readonly type="text " id="floor" name="floor" class="form-control" value = "2">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group col-12">
                    ...
                    <textarea id="message2" name="detail" rows="5" class="form-control" placeholder="เขียนข้อความของคุณที่นี่"></textarea>
                  </div>
                  <button type="submit" id="btn-submit2" name="btn-submit2" class="btn btn-primary d-block mx-auto"> Submit </button>
                </div>
              </form>
