...
<body>
    ...
    <section class="container py-3">
      ...
      <section>
        <div class="row">
          <div class="col-md-8">
              <img src="assets/image/diagram/floor8.jpg"class="img-fluid" width="800" height="600" alt="">
          </div>
  
            <div class="col-md-4 pl-5 text-center" style=" height: 220px; overflow: scroll;">
              <h2> เลือกห้อง </h2> 
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-8R01" id = "b801">
              <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-8R02" id = "b802">
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-8R03" id = "b803">
              <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-8R04" id = "b804">
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-8R05" id = "b805">
              <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-8R06" id = "b806">
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-8R07" id = "b807">
              <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-8R08" id = "b808">  
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-8R09" id = "b809">
              <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-8R10" id = "b810"> 
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-8R11" id = "b811">
            </div>          
          </div>         
        </section>
              ...
              <form>
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" id="floor8" class="form-control" placeholder="ชั้นที่่ต้องการแจ้ง">
                  </div>

                  <div class="form-group col-md-4">
                    <label for="room"> ห้อง </label>
                    <input type="text" id="room8" class="form-control" placeholder="ห้องที่ต้องการแจ้ง" value="">
                 </div>
