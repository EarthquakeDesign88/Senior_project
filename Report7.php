...
<body>
    ...
    <section class="container py-3">
      ...
      <section>
        <div class="row">
          <div class="col-md-8">
              <img src="assets/image/diagram/floor7.jpg"class="img-fluid" width="800" height="600" alt="">
          </div>
  
            <div class="col-md-4 pl-5 text-center " style=" height: 180px; overflow: scroll;">
              <h2> เลือกห้อง </h2> 
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-7T01" id = "b701">
              <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-7T02" id = "b702">
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-7T03" id = "b703">
              <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-7T04" id = "b704">
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-7T05" id = "b705">
              ...
              <form>
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" id="floor7" class="form-control" placeholder="ชั้นที่่ต้องการแจ้ง">
                  </div>

                  <div class="form-group col-md-4">
                    <label for="room"> ห้อง </label>
                    <input type="text" id="room7" class="form-control" placeholder="ห้องที่ต้องการแจ้ง" value = "">
                 </div>
