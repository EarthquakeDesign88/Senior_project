...
<body>
    ...
    <section class="container py-3">
      ...
      <div class="row">
        <div class="col-md-12">
            <img src="assets/image/diagram/floor7.jpg"class="img-fluid p-1" width="1300" height="200" alt="">
        </div>
              ...
              <form method = "post" action = "php/form.php">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" id="floor" name="floor" class="form-control" required value = "ชั้น 7">
                  </div>
