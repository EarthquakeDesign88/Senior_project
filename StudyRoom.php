...
<body>
    ...
    <!--Section Page-title-->
    <header  class="jarallax" data-jarallax ='{"speed": 0.6}' style="background-image: url('https://images.unsplash.com/photo-1524749292158-7540c2494485?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80');">
      <div class="blog-image">
        <h1 class = "display-5 font-weight-bold"> ห้องจัดการศึกษา </h1>
