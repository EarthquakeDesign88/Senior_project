...
<body>
    ...
    <!--Section Page-title-->
    <header  class="page-title jarallax " data-jarallax ='{"speed": 0.6}' style="background-image: url('assets/image/chartbackD.jpg');">
    ...
    <section class="container py-3">
      <div class="row">
        <div class="col-12">
            <h1 class = "border-short-bottom text-center" style="color: #000000 "> Statistics Of Day </h1>
        </div>
...
<div class="row pl-5">
    ...
    <select  name="month"  id="month"  class = "p-2" style=" height: 40px; width: 300px; overflow: scroll;">
        ...
        <input type="text" id="day" name="day" class="form-control" required placeholder="กรอกวันที่ต้องการค้นหา">
        </div>
