...
<body>
    ...
    <section class="container py-3">
     ...
     <section>
      <div class="row">
        <div class="col-md-8">
            <img src="assets/image/diagram/floor4.jpg"class="img-fluid" width="800" height="600" alt="">
        </div>

          <div class="col-md-4 pl-5 text-center " style=" height: 180px; overflow: scroll;">
            <h2> เลือกห้อง </h2> 
            <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-4C01" id = "b401">
            <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-4C02" id = "b402">
            <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-4C03" id = "b403">
            <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-4C04" id = "b404">
            <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-4M210" id = "b4M">                                            
          </div> 
              ...
              <form>
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" id="floor4" class="form-control" placeholder="ชั้นที่่ต้องการแจ้ง">
                  </div>

                  <div class="form-group col-md-4">
                    <label for="room"> ห้อง </label>
                    <input type="text" id="room4" class="form-control" placeholder="ห้องที่ต้องการแจ้ง" value = "">
                 </div>
