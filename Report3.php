...
<body>
    ...
    <section class="container py-3">
     ...
     <section>
      <div class="row">
        <div class="col-md-8">
            <img src="assets/image/diagram/floor3.jpg"class="img-fluid" width="800" height="600" alt="">
        </div>

          <div class="col-md-4 pl-5 text-center " style=" height: 180px; overflow: scroll;">
            <h2> เลือกห้อง </h2>  
            <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-3C01" id = "b301">
            <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-3C02" id = "b302">
            <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-3C03" id = "b303">
            <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-3C04" id = "b304">
            <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-3M210" id = "b3M">
              ...
              <form>
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" id="floor3" class="form-control" placeholder="ชั้นที่่ต้องการแจ้ง">
                  </div>

                  <div class="form-group col-md-4">
                    <label for="room"> ห้อง </label>
                    <input type="text" id="room3" class="form-control" placeholder="ห้องที่ต้องการแจ้ง" value = "">
                 </div>
