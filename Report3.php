...
<body>
    ...
    <header  class="page-title jarallax" data-jarallax ='{"speed": 0.6}' style="background-image: url('https://www.rockwellautomation.com/resources/images/rockwellautomation/publication/repair-shutterstock_133644224--photograph_848w477h.jpg');">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class = "display-5 font-weight-bold text-center " style="color: #000000; font-size: 6rem" > 3<sup>rd</sup> Floor </h1>
    ...
    <section class="container py-3">
      <div class="row">
        <div class="col-12">
            <h1 class = "border-short-bottom text-center" style="color: #000000 "> 3<sup>rd</sup> Floor Plan </h1>
        </div>
      </div>
              ...
              <form method = "post" action ="php/form.php" enctype = "multipart/form-data">
                <div class="form-row">
                  ...
                  <label for="floor"> Floor </label>
                    <input  readonly type="text " id="floor" name="floor" class="form-control" value = "3">
                 ...
                 <div class="col-md-3">
                  ...
                  <button type="submit" id="btn-submit3" name="btn-submit3" class="btn btn-primary d-block mx-auto"> Submit </button>
                </div>
              </form>
