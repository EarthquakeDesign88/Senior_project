...
<body>
    ...
    <header  class="page-title jarallax" data-jarallax ='{"speed": 0.6}' style="background-image: url('https://www.rockwellautomation.com/resources/images/rockwellautomation/publication/repair-shutterstock_133644224--photograph_848w477h.jpg');">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class = "display-5 font-weight-bold text-center " style="color: #000000; font-size: 6rem" > Floor3 </h1>
    ...
    <section class="container py-3">
      <div class="row">
        <div class="col-12">
            <h1 class = "border-short-bottom text-center" style="color: #000000 "> แผนผังชั้น3 </h1>
        </div>
      </div>
     ...
     <section>
      <div class="row">
        <div class="col-md-12">
            <img src="assets/image/diagram/floor3.jpg"class="img-fluid p-1" width="1300" height="200" alt="">
        </div>
              ...
              <form method = "post" action = "php/form.php" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <label for="floor"> ชั้น </label>
                    <input  readonly type="text " id="floor" name="floor" class="form-control" value = "ชั้น 3">
                  </div>

                  <div class="form-group col-md-4 ">
                    <label  for="area "> ห้อง/บริเวณ </label> <br>
                    <select name="area" class = "p-2" style=" height: 40px; width: 300px; overflow: scroll;">
                      <option value="IF-308"> IF-308 </option>
                      <option value="IF-309"> IF-309 </option>
                      <option value="IF-3C01"> IF-3C01 </option>
                      <option value="IF-3C02"> IF-3C02 </option>
                      <option value="IF-3C03"> IF-3C03 </option>
                      <option value="IF-3C04"> IF-3C04 </option>              
                      <option value="IF-3M210"> IF-3M210 </option>
                      <option value="ห้องน้ำชาย ชั้น3"> ห้องน้ำชาย ชั้น3  </option>
                      <option value="ห้องน้ำหญิง ชั้น3"> ห้องน้ำหญิง ชั้น3 </option>
                      <option value="ห้องน้ำผู้พิการ ชั้น3"> ห้องน้ำผู้พิการ ชั้น3  </option>
                      <option value="ห้องน้ำอาจารย์ ชั้น3 "> ห้องน้ำอาจารย์ ชั้น3  </option>
                      <option value="บันได ชั้น3"> บันได ชั้น3 </option>
                      <option value="ห้องสื่อสาร ชั้น3"> ห้องสื่อสาร ชั้น3 </option>
                      <option value="ลิฟต์1 ชั้น3"> ลิฟต์1 ชั้น3 </option>
                      <option value="ลิฟต์2 ชั้น3"> ลิฟต์2 ชั้น3 </option>
                      <option value="ลิฟต์3 ชั้น3"> ลิฟต์3 ชั้น3 </option>
                      <option value="ลิฟต์ดับเพลิง ชั้น3"> ลิฟต์ดับเพลิง ชั้น3 </option>
                      <option value="ห้องไฟฟ้า ชั้น3"> ห้องไฟฟ้า ชั้น3 </option>
                      <option value="ทางหนีไฟ ชั้น3"> ทางหนีไฟ ชั้น3 </option>
                ...
                <div class="col-md-4">
                  ...
                  <button type="submit" id="btn-submit3" name="btn-submit3"  class="btn btn-primary d-block mx-auto"> ส่งข้อความ </button>
                </div>
              </form>
