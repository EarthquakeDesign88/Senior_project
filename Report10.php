...
<body>
    ...
    <header  class="page-title jarallax" data-jarallax ='{"speed": 0.6}' style="background-image: url('https://www.rockwellautomation.com/resources/images/rockwellautomation/publication/repair-shutterstock_133644224--photograph_848w477h.jpg');">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class = "display-5 font-weight-bold text-center " style="color: #000000; font-size: 6rem" > Floor10 </h1>
    ...
    <section class="container py-3">
      <div class="row">
        <div class="col-12">
            <h1 class = "border-short-bottom text-center" style="color: #000000 "> แผนผังชั้น10 </h1>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
            <img src="assets/image/diagram/floor10.jpg"class="img-fluid p-1" width="1300" height="200" alt="">
        </div>
              ...
              <form method = "post" action = "php/form.php"enctype="multipart/form-data" >
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input  readonly type="text " id="floor" name="floor" class="form-control" value = "ชั้น 10">
                  </div>

                  <div class="form-group col-md-4 ">
                    <label  for="area "> ห้อง/บริเวณ </label> <br>
                    <select name="area" class = "p-2" style=" height: 40px; width: 300px; overflow: scroll;">
                      <option value="IF-1008"> IF-1008 </option>
                      <option value="IF-1009"> IF-1009 </option>
                      <option value="IF-1010"> IF-1010 </option>
                      <option value="IF-1011"> IF-1011 </option>
                      <option value="IF-10M32"> IF-10M32 </option> 
                      <option value="IF-10M56"> IF-10M56 </option>
                      <option value="IF-10M60"> IF-10M60 </option>                    
                      <option value="ห้องน้ำชาย ชั้น10"> ห้องน้ำชาย ชั้น10  </option>
                      <option value="ห้องน้ำหญิง ชั้น10"> ห้องน้ำหญิง ชั้น10 </option>
                      <option value="ห้องน้ำผู้พิการ ชั้น10"> ห้องน้ำผู้พิการ ชั้น10  </option>
                      <option value="ห้องแม่บ้าน ชั้น10 "> ห้องแม่บ้าน ชั้น10  </option>
                      <option value="บันได ชั้น10"> บันได ชั้น10 </option>
                      <option value="ห้องสื่อสาร ชั้น10"> ห้องสื่อสาร ชั้น10 </option>
                      <option value="ลิฟต์1 ชั้น10"> ลิฟต์1 ชั้น10 </option>
                      <option value="ลิฟต์2 ชั้น10"> ลิฟต์2 ชั้น10 </option>
                      <option value="ลิฟต์3 ชั้น10"> ลิฟต์3 ชั้น10 </option>
                      <option value="ลิฟต์ดับเพลิง ชั้น10"> ลิฟต์ดับเพลิง ชั้น10 </option>
                      <option value="ห้องไฟฟ้า ชั้น10"> ห้องไฟฟ้า ชั้น10 </option>
                      <option value="ทางหนีไฟ ชั้น10"> ทางหนีไฟ ชั้น10 </option>
                ...
                <div class="col-md-4">
                  ...
                  <button type="submit"  id="btn-submit10" name="btn-submit10" class="btn btn-primary d-block mx-auto"> ส่งข้อความ </button>
                </div>
              </form>
