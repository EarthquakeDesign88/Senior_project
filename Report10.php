...
<body>
    ...
    <section class="container py-3">
      ...
      <section>
        <div class="row">
          <div class="col-md-8">
              <img src="assets/image/diagram/floor10.jpg"class="img-fluid" width="800" height="600" alt="">
          </div>
  
            <div class="col-md-4 pl-5 text-center " style=" height: 220px; overflow: scroll;">
              <h2> เลือกห้อง </h2> 
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-1008" id = "b1008">
              <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-1009" id = "b1009">
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-1010" id = "b1010">
              <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-1011" id = "b1011">
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-10M32" id = "b10m32">
              <input type="button" class="btn btn-secondary active dropdown-item p-2"  value = "IF-10M56" id = "b10m56"> 
              <input type="button" class="btn btn-primary active dropdown-item p-2"  value = "IF-10M60" id = "b10m60">                 
            </div> 
              ...
              <form>
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="floor" id="floor10" class="form-control" placeholder="ชั้นที่่ต้องการแจ้ง">
                  </div>

                  <div class="form-group col-md-4">
                    <label for="email"> ห้อง </label>
                    <input type="room" id="room10" class="form-control" placeholder="ห้องที่ต้องการแจ้ง" value = "">
                 </div>
